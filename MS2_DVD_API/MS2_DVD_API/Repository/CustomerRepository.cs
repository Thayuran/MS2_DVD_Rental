...
namespace MS2_DVD_API.Repository
{
    public class CustomerRepository : ICustomerRepository
    {
        ...
        public async Task<Customer> AddCustomer(Customer customer)
        {
            using (var connection = new SqlConnection(_connectionString))
            {
                ...
                var command = new SqlCommand(
                    "INSERT INTO Customers (FullName, Email, Address, PhoneNumber, JoinedDate, Action) " +
                    "VALUES (@FullName, @Email, @Address, @PhoneNumber, @JoinedDate, @Action)", connection);
        ...
        public async Task<Customer> UpdateCustomer(Customer customer)
        {
            using (var connection = new SqlConnection(_connectionString))
            {
                ...
                var command = new SqlCommand(
                    ...
                    "PhoneNumber = @PhoneNumber, JoinedDate = @JoinedDate, Action = @Action " +
        ...
        {
            return await UpdateCustomerAction(customerId, true);
        }
